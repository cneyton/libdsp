...
int main(int argc, char * argv[])
{
    ...
    auto roll_filter = std::make_unique<filter::Roll<T1>>(logger, nperseg, 1);
    ...
    pipeline.link<T1>(source_h, "out", iir_h , "in");
    pipeline.link<T1>(iir_h   , "out", roll_h, "in");
    pipeline.link<T1>(roll_h  , "out", fd_h  , "in");
